  ...
  <body>
    ...
    <section class="w3-row">
      ...
      <div class="w3-large w3-half w3-container w3-card w3-justify" onclick="w3_close()">
        <div id="about" class="w3-card w3-padding w3-margin-top">
          <h2>Who we are</h2>
        ...
        <div id="clients" class="w3-card w3-padding w3-margin-top">
          <h2>Our clients</h2>
        ...
        <div id="philosophy" class="w3-card w3-padding w3-margin-top">
        ...
        <div id="specialisms" class="w3-card w3-padding w3-margin-top w3-margin-bottom" style="padding-bottom:24px!important">
          ...
          <button onclick="myFunction('languages')" class="w3-btn w3-block w3-center devexe-red w3-xlarge w3-hide-medium w3-hide-small">Programming, query and transformation languages</button>
          <button onclick="myFunction('languages')" class="w3-btn w3-block w3-center devexe-red w3-xlarge w3-hide-large">Languages</button>
          ...
          <button onclick="myFunction('standards')" class="w3-btn w3-block w3-center devexe-red w3-xlarge w3-margin-top w3-hide-medium w3-hide-small">International Standards &amp; Specifications</button>
          <button onclick="myFunction('standards')" class="w3-btn w3-block w3-center devexe-red w3-xlarge w3-margin-top w3-hide-large">Standards</button>
          ...
          <button onclick="myFunction('frameworks')" class="w3-btn w3-block w3-center devexe-red w3-xlarge w3-margin-top">Frameworks</button>
          ...
          <button onclick="myFunction('databases')" class="w3-btn w3-block w3-centre devexe-red w3-xlarge w3-margin-top w3-hide-medium w3-hide-small">Database and document management systems</button>
          <button onclick="myFunction('databases')" class="w3-btn w3-block w3-centre devexe-red w3-xlarge w3-margin-top w3-hide-large">Storage</button>
        ...
        <div id="contact" class="w3-card w3-padding w3-margin-top">
          <h2>Contact us</h2>
          ...
          <div class="w3-card-4 w3-light-grey w3-margin-bottom">
            <form class="w3-container w3-padding-large" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post">
              ...
              <div style="padding-top:10px">
                ...
                <textarea class="w3-input w3-border" style="resize:none" name="message"></textarea>
              </div>
              <button type="submit" class="w3-btn devexe-red w3-margin-top">Submit</button>
              <br/><br/>
            </form>
          </div>
        </div>
